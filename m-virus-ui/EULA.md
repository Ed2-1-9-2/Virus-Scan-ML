...
This End-User License Agreement ("Agreement") is a legal agreement between you ("User") and the copyright holder of this software ("Licensor") for the use of the M-Virus software, including related source code, binaries, machine-learning models, weights, configuration files, and documentation ("Software").
